...
*/
import { AbstractMesh, ActionManager, Color4, ExecuteCodeAction, ISceneLoaderAsyncResult, ParticleSystem, PhysicsImpostor, SixDofDragBehavior, Sound, Texture, Vector3 } from "babylonjs";
...
export class Beaker extends Entity{
    ...
    Init(): void {
        ...
        this.m_BeakerModelEntity = this.m_ECS.Instantiate(BeakerModel, "Beaker Model");
